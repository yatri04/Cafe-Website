            ...
            <Card className="card-3d bg-cream-50 border-0">
              <CardContent className="p-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                  <h3 className="font-serif text-2xl font-bold text-brown-900 mb-4">Send a Message</h3>
                  <Input
                    name="name"
                  ...
                  <Textarea
                    ...
                    required
                  />
                  <Button type="submit" disabled={loading} className="bg-brown-600 hover:bg-brown-700 text-cream-50 rounded-full">
